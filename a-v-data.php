                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 style="color: #28a745;"><b>Visitor's View</b></h4>
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered table-striped" id="product-table">
                                ...
                                <tbody>
                                    ...
                                    <?php               
                                        $select_products = $conn->prepare("SELECT * FROM visit_history");
                                        ...
                                        if ($select_products->rowCount() > 0) {
                                            while ($fetch_products = $select_products->fetch(PDO::FETCH_ASSOC)) {
                                                ?>
                                                <tr>
                                                    <td class="align-middle text-center"><?= $fetch_products['visitID']; ?></td>
                                                    <td class="align-middle text-center"><?= $fetch_products['house_Num']; ?></td>
