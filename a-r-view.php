                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 style="color: #28a745;"><b>Resident's View</b>
                            ...
                            <table class="table table-bordered table-striped" id="product-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">House Number</th>
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        $select_products = $conn->prepare("SELECT * FROM residence");
                                        ...
                                        if ($select_products->rowCount() > 0) {
                                            while ($fetch_products = $select_products->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center"><?= $fetch_products['House_Number']; ?></td>
                                                    <td class="align-middle text-center"><?= $fetch_products['Block']; ?></td>
                                                    <td class="align-middle text-center"><?= $fetch_products['First_Name']; ?></td>
                                                    <td class="align-middle text-center"><?= $fetch_products['Last_Name']; ?></td>
                                                    <!-- <td class="align-middle text-center">
                                                        <img src="../uploaded_img/<?= $fetch_products['image']; ?>" alt="Product Image" width="100" height="100">
                                                    </td> -->
                                                    <td>
                                                        <a href="a-edit-res.php?id=<?= $fetch_products['ID']; ?>" class="fas fa-eye"></a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
