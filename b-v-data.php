                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 style="color: #28a745;"><b>Visit Log</b></h4>
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered table-striped" id="product-table">
                                <thead>
                                    <tr>
                                        <td class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"><b>ID</b></td>
                                        <td class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"><b>First Name</b></td>
                                        <td class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"><b>Last Name</b></td>
                                        
                                        <td class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"><b>Date Inquire</b></td>
                                        <td class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"><b>Validity</b></td>
                                        <td class="text-center text-secondary opacity-7"><b>Status</b></td>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php
            ...
            <td class="align-middle text-center"><?= $fetch_products['expireDate']; ?></td>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <div style="text-align: center;">
                                                            <a href="n-o-visitor-e.php?id=<?= $fetch_products['visitID']; ?>"><i class="fas fa-eye" style="padding-right: 10px;"></i></a>
                                                            <span>|</span>
                                                            <a href="user_data_delete_page.php?id=<?= $fetch_products['visitID']; ?>"><i class="fas fa-trash" style="padding-left: 10px; color: #F45353"></i></a>
                                                        <div>
                                                    </td>
                                                </tr>
                                                <?php
